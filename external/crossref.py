...
class CrossRefAPI:
    ...
    async def search(self, query: str, limit: int = 300) -> list[Hit]:
    ...
    def filter_hits(self, hits: list[Hit], original_query: str) -> list[Hit]:
        ...
        return list(filter(lambda h: _simple_keyword_in_title_filter(h) and _published_year_filter(h, (2015, 2025)), hits))
